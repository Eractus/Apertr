...
demo_photo12 = Photo.create(title: "Gulfoss", description:"this majestic waterall's name is icelandic for golden falls", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed7.jpg')), user_id: demo_user.id)
demo_photo13 = Photo.create(title: "Puffin", description:"closeup of this native bird", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed8.jpg')), user_id: demo_user.id)
demo_photo14 = Photo.create(title: "Kirjufell", description:"iconic mountain now made famous by game of thrones", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed9.jpg')), user_id: demo_user.id)
demo_photo15 = Photo.create(title: "Seljalandsfoss", description:"waterfall where you can walk behind", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed10.jpg')), user_id: demo_user.id)
demo_photo16 = Photo.create(title: "Icelandic Architecture", description:"overhead shot of an icelandic city", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed11.jpg')), user_id: demo_user.id)
demo_photo17 = Photo.create(title: "Skogafoss", description:"a powerfall waterfall during winter", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed12.jpg')), user_id: demo_user.id)
demo_photo18 = Photo.create(title: "Godafoss", description:"another powerfall waterfall during winter", image: File.open(File.join(Rails.root, '/app/assets/images/iceland_seed13.jpg')), user_id: demo_user.id)
