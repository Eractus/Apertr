...
seed_photo28 = Photo.create(title: "Honda CRV's", description:"lots happening on the dance floor", image: File.open(File.join(Rails.root, '/app/assets/images/seeds/shao_seed3.jpg')), user_id: user6.id)
